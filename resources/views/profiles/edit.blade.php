@extends('layouts.default', ['title' => 'Mon profil'])
@section('css')
    <link rel="stylesheet"
...
@section('card')
    @component('components.card')
        ...
        <form method="POST" action="{{ route('profile.update', $user->id) }}">
            @csrf
            @method('PUT')
            @include('layouts/partials/_form-group', [
...
@section('script')
    ...
    @include('layouts.partials._script-delete', ['text' => __('Vraiment supprimer votre compte ?'), 'return' => 'home'])
@endsection
